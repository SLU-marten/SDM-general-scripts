...
# Model parameters
timePeriod <- tibble("2005_2022" = c(2005, 2022),  "1972_2004" = c(1972, 2004)) 
quarter <- list("All" = c(1,2,3,4), "Q1" = 1) 
modelID <- "20240516"
...
# modQuartoFuncSDM_pre(modelID, names(species), timePeriod, quarter, dfAbu)
```
